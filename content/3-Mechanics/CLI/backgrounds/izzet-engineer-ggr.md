...
- **Skill Proficiencies.** [Arcana](content/3-Mechanics/CLI/rules/skills.md#Arcana), [Investigation](content/3-Mechanics/CLI/rules/skills.md#Investigation)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [produce flame](produce-flame.md), [shocking grasp](shocking-grasp.md) |
| 1st | [chaos bolt](chaos-bolt-xge.md), [create or destroy water](create-or-destroy-water.md), [unseen servant](unseen-servant.md) |
| 2nd | [heat metal](heat-metal.md), [rope trick](rope-trick.md) |
| 3rd | [call lightning](call-lightning.md), [elemental weapon](elemental-weapon.md), [glyph of warding](glyph-of-warding.md) |
| 4th | [conjure minor elementals](conjure-minor-elementals.md), [divination](divination.md), [Otiluke's resilient sphere](otilukes-resilient-sphere.md) |
| 5th | [animate objects](animate-objects.md), [conjure elemental](conjure-elemental.md) |
^izzet-guild-spells

Your spells tend to be loud, flashy, or explosive, even when the effect is unremarkable. For example, when you open the portal of a [rope trick](rope-trick.md) spell, the portal might be outlined by harmless, showy sparkles.
