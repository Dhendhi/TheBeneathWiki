...
NoteIcon: background
BookSource: Guildmasters' Guide to Ravnica p. 46
---
# Dimir Operative
*Source: Guildmasters' Guide to Ravnica p. 46*  

- **Skill Proficiencies.** [Deception](content/3-Mechanics/CLI/rules/skills.md#Deception), [Stealth](content/3-Mechanics/CLI/rules/skills.md#Stealth)  
- **Tool Proficiencies.** [Disguise kit](disguise-kit.md)  
- **Languages.** One of your choice  
- **Equipment.** A Dimir insignia, three small knives, a set of dark-colored [common clothes](common-clothes.md), and the starting equipment of the background described in this chapter for your secondary guild  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [encode thoughts](encode-thoughts-ggr.md), [mage hand](mage-hand.md) |
| 1st | [disguise self](disguise-self.md), [sleep](sleep.md) |
| 2nd | [detect thoughts](detect-thoughts.md), [pass without trace](pass-without-trace.md) |
| 3rd | [gaseous form](gaseous-form.md), [meld into stone](meld-into-stone.md), [nondetection](nondetection.md) |
| 4th | [arcane eye](arcane-eye.md), [freedom of movement](freedom-of-movement.md) |
| 5th | [modify memory](modify-memory.md) |
^dimir-guild-spells
