...
- **Skill Proficiencies.** [Arcana](content/3-Mechanics/CLI/rules/skills.md#Arcana), [Medicine](content/3-Mechanics/CLI/rules/skills.md#Medicine)  
- **Languages.** Two of your choice  
- **Equipment.** A Simic insignia, a set of [commoner's clothes](common-clothes.md), a [book](book.md) of research notes, an [ink pen](ink-pen.md), a [bottle of squid ink](ink-1-ounce-bottle.md), a [flask of oil](oil-flask.md) (made from blubber), a [vial of acid](acid-vial.md) (derived from digestive juices), a vial of fish scales, a vial of seaweed, a vial of jellyfish stingers, a glass bottle of unidentified slime, and a belt [pouch](pouch.md) containing 10 gp (Azorius 1-zino coins)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [acid splash](acid-splash.md), [druidcraft](druidcraft.md) |
| 1st | [detect poison and disease](detect-poison-and-disease.md), [expeditious retreat](expeditious-retreat.md), [jump](jump.md) |
| 2nd | [alter self](alter-self.md), [enhance ability](enhance-ability.md), [enlarge/reduce](enlarge-reduce.md) |
| 3rd | [gaseous form](gaseous-form.md), [water breathing](water-breathing.md), [wind wall](wind-wall.md) |
| 4th | [freedom of movement](freedom-of-movement.md), [polymorph](polymorph.md) |
