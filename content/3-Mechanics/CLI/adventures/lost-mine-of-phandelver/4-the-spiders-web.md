...
> [!gallery]
> ![The Sword Coast](the-sword-coast.jpg#gallery)
> ![Player Version](the-sword-coast-player.jpg#gallery)
...
Twelve [zombies](zombie.md) lurk inside the crumbled shell of the old watchtower and can't be seen from outside. However, any character with a passive Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) score of 10 or higher smells a deathly odor wafting from the tower's direction. When characters approach the tower or the tent, the zombies shamble out of the tower.
...
Kost is a stout, red-robed figure with sallow skin, a shaved scalp, and a black tattoo on his forehead. A character who succeeds on a DC 10 Intelligence ([Arcana](content/3-Mechanics/CLI/rules/skills.md#Arcana)) check recognizes Kost's tattoo as a necromantic symbol. A successful DC 10 Intelligence ([History](content/3-Mechanics/CLI/rules/skills.md#History)) check verifies the garb as that usual for Thay, a land far to the east where wizards pattern their flesh with tattoos. The tattoo on the head represents a wizard's school of magic. Kost's school is necromancy.
...
> [!gallery]
> ![Ruins of Thundertree](ruins-of-thundertree.jpg#gallery)
> ![Player Version](ruins-of-thundertree-player.jpg#gallery)
...
Two [twig blights](twig-blight.md) hide among the weeds that flank the cottage's open doorway. Make a Dexterity ([Stealth](content/3-Mechanics/CLI/rules/skills.md#Stealth)) check for the blights, and compare the result to the passive Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) scores of the characters to determine if the blights are spotted.
...
The overgrowth conceals a deadly threat-six [twig blights](twig-blight.md) lurking among the ordinary foliage. Spotting them requires a successful Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) check challenged by the blights' Dexterity ([Stealth](content/3-Mechanics/CLI/rules/skills.md#Stealth)) check.
...
A merchant who once lived here had a chest full of coins hidden under the flagstone floor of his home. A thorough search of the interior of the eastern cottage and a successful DC 10 Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) check reveals the old chest among the roots of the tree growing up through the house. The chest contains 700 cp, 160 sp, and 90 gp.
...
Two [giant spiders](giant-spider.md) hide on the inner walls in this ruined building, so they are not visible from outside. Trailing lines from the webs in the lane allow the spiders to sense when prey is moving through the webs, at which point they nimbly scuttle over the wall and attack. The alert spiders surprise any character whose passive Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) score is less than 17.

### Webs

The webs fill two squares north of the doorway (and the square marked "6"). They are difficult terrain, and a creature trying to move through them must succeed on a DC 10 Strength ([Athletics](content/3-Mechanics/CLI/rules/skills.md#Athletics)) check. On a failure, the creature is [restrained](conditions.md#restrained) in the [webs](webs.md) (see the rulebook for the effects of being [restrained](conditions.md#restrained)). A snared creature can take an action each round to attempt to break free with a DC 12 Strength check, or it can try to cut its way free by using a light weapon that deals slashing damage. The webs have AC 10, 5 hit points, vulnerability to fire damage, and immunity to bludgeoning, poison, and psychic damage (see "Damage Resistance and Vulnerability" in the rulebook for how vulnerability works).
...
All the reagents and concoctions here have long since been ruined, and the books are unreadable masses of rot. However, a small wooden case is hidden in a compartment beneath the storage shelves. A character searching through the wreckage can find the case with a successful DC 15 Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) check. The check succeeds automatically if Mirna sent the party to find the heirloom.
...
The leaning statue is ten feet tall, including the base. It depicts an old hero of Neverwinter named Palien, who supposedly defeated several monsters in Neverwinter Wood when Thundertree was first founded. A character who studies the statue recognizes the depiction with a successful DC 15 Intelligence ([History](content/3-Mechanics/CLI/rules/skills.md#History)) check. The statue can be knocked over with a successful DC 20 Strength check.
...
Six [twig blights](twig-blight.md) lurk in the thicket south of this ruin. Allow each character to attempt a Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) check contested by the blights' Dexterity ([Stealth](content/3-Mechanics/CLI/rules/skills.md#Stealth)) check to avoid being surprised by them.
...
Wyvern Tor is a sizable hill, with miles of rugged terrain on its flanks and slopes. Searching for the hidden orc camp takes time. The party can attempt one DC 15 Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) check or DC 10 Wisdom ([Survival](content/3-Mechanics/CLI/rules/skills.md#Survival)) check per hour to find the camp, made by the character leading the way.
...
> [!gallery]
> ![Cragmaw Castle](cragmaw-castle.jpg#gallery)
> ![Player Version](cragmaw-castle-player.jpg#gallery)
...
If the characters try to perpetrate a deception as a group, have them each make a Charisma ([Deception](content/3-Mechanics/CLI/rules/skills.md#Deception)) check contested by the monsters' Wisdom ([Insight](content/3-Mechanics/CLI/rules/skills.md#Insight)) checks, and give the characters advantage on their checks if the deception is particularly well planned or roleplayed. If at least one of the characters win the contest, the deception is a success. As the party makes its way deeper into the castle, additional checks might be required, at your discretion.
...
The dusty plaster and rubble in front of the door leading to 8 conceals a copper tripwire connected to linchpins hidden in the ruined ceiling. Spotting the tripwire requires a passive Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) score of at least 20, or a successful DC 10 Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) check if characters are actively searching for traps in the area. Once spotted, the tripwire is easily avoided and disarmed (no ability check required).
...
This chamber contains a [grick](grick.md), the special pet of the goblin Lhupo (9). The grick like to climb up to a ledge hidden in the shadows of the statuary in the higher reaches of the room. It quietly observes intruders that enter the area before dropping down to strike. Compare the grick's Dexterity ([Stealth](content/3-Mechanics/CLI/rules/skills.md#Stealth)) check to the characters' Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) checks (or their passive scores) to determine who among them is surprised. The grick knows that goblins are not to be eaten unless Lhupo says so. The rest of the Cragmaws are terrified of Lhupo's pet and hurry through this room, preferably in twos or threes.

Any cleric who examines the chapel's decor can attempt a DC 10 Intelligence ([Religion](content/3-Mechanics/CLI/rules/skills.md#Religion)) check to identify the deities that were once revered here: Oghma (god of knowledge), Mystra (goddess of magic), Lathander (god of dawn), and Tymora (goddess of luck). This is an obvious sign that the builders of the castle were human.
...
Dusty canvas (marked with a "C" on the map) hides the northern entrance to this area, blending in with the surrounding stonework and rubble. A character who succeeds on a DC 15 Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) check spots a footpath leading up to the hidden entrance. If the characters are actively searching the outside of the castle for a hidden entrance, they can make a DC 10 Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) check to spot the canvas "door."
...
All that remains of the tower's second floor is a jagged ledge, upon which sits a battered wooden chest. The chest is hard to see from the floor, requiring a successful DC 15 Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) check to notice. The chest is unlocked and contains 90 ep, 120 gp, a [potion of healing](potion-of-healing.md), a [scroll of](spell-scroll-2nd-level.md) [silence](silence.md), and a [scroll of](spell-scroll-3rd-level.md) [revivify](revivify.md).
