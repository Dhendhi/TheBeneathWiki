...
- Review the goblin stat block in appendix B. Since the goblins are hiding, you'll need to know their [Stealth](content/3-Mechanics/CLI/rules/skills.md#Stealth) skill modifier: +6.  
- Check to see who, if anyone, is surprised. The party cannot surprise the goblins, but the goblins might surprise some or all the characters. Make a Dexterity ([Stealth](content/3-Mechanics/CLI/rules/skills.md#Stealth)) check for the goblins, rolling once for all of them. Roll a `d20`, add the goblins' [Stealth](content/3-Mechanics/CLI/rules/skills.md#Stealth) skill modifier (+6) to the roll, and compare the result to the characters' passive Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) scores. Any character whose score is lower than the goblins' check result is surprised and loses his or her turn during the first round of combat (see "Surprise" in the rulebook).  
...
> [!gallery]
> ![Cragmaw Hideout](cragmaw-hideout.jpg#gallery)
> ![Player Version](cragmaw-hideout-player.jpg#gallery)
...
The sound of water in the cave muffles noises to any creatures that aren't listening carefully. Creatures can make a DC 15 Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) check to attempt to hear activity in nearby chambers.
...
Characters moving carefully or scouting ahead might be able to surprise the goblin lookouts. Have each character who moves ahead make a Dexterity ([Stealth](content/3-Mechanics/CLI/rules/skills.md#Stealth)) check contested by the goblins' passive Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) score to avoid being surprised. See the rulebook for more information on ability check contests.
...
Any character who can see the bridge in 5 might also notice the goblin guarding the bridge. Doing so requires a Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) check contested by the goblin's Dexterity ([Stealth](content/3-Mechanics/CLI/rules/skills.md#Stealth)) check result.

The goblin notices the characters if they carry any light or don't use stealth as they approach the bridge. The goblin does not attack. Instead, it attempts to sneak away to the east to inform its companions in 7 to release a flood (see the "Flood!" section of 5). The goblin moves undetected if its Dexterity ([Stealth](content/3-Mechanics/CLI/rules/skills.md#Stealth)) check exceeds the passive Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) score of any character who might notice its movements.
...
One [goblin](goblin.md) stands watch on the bridge. It is hiding, and characters can spot it by succeeding on a Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) check contested by the goblin's Dexterity ([Stealth](content/3-Mechanics/CLI/rules/skills.md#Stealth)) check. This guard is lazy and inattentive. If no characters are using light sources, each character can attempt a Dexterity ([Stealth](content/3-Mechanics/CLI/rules/skills.md#Stealth)) check against the goblin's passive Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) score to creep by without being noticed.
...
This bridge spans the passage 20 feet above the stream. It's possible to climb up the cavern walls from the lower passage to the bridge. The 20-foot-high walls are rough but slick with spray, requiring a successful DC 15 Strength ([Athletics](content/3-Mechanics/CLI/rules/skills.md#Athletics)) check to climb.
