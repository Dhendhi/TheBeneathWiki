...
SourceType: "Race"
NoteIcon: race
BookSource: Astral Adventurer's Guide p. 15
---
# Thri-kreen
*Source: Astral Adventurer's Guide p. 15*  
![](/3-Mechanics/CLI/races/img/thri-kreen.webp#right)  
...
As an action, you can change the color of your carapace to match the color and texture of your surroundings, giving you advantage on Dexterity ([Stealth](/3-Mechanics/CLI/rules/skills.md#Stealth)) checks made to [hide](/3-Mechanics/CLI/rules/actions.md#hide) in those surroundings.
