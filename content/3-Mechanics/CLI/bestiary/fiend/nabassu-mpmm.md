...
- "desc": "The nabassu targets one creature it can see within 30 feet of it. If the\
    ...
    \ to 0, and if the target is a Humanoid, it immediately rises as a [ghoul](/3-Mechanics/CLI/bestiary/undead/ghoul.md)\
    \ under the nabassu's control."
  "name": "Soul-Stealing Gaze"
"source":
- "MPMM"
- "MTF"
"image": "/3-Mechanics/CLI/bestiary/fiend/token/nabassu.png"
```
^statblock
