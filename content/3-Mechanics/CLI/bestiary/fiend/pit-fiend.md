...
SourceType: Bestiary
BookSource: Monster Manual p. 77, Tasha's Cauldron of Everything. Available in the SRD.
---
...
- "desc": "Melee Weapon Attack: +14 to hit, reach 5 ft., one target. Hit: 22 (4d6\
    ...
    \ throw or become [poisoned](/3-Mechanics/CLI/rules/conditions.md#poisoned). While\
    ...
    \ of each of its turns. The [poisoned](/3-Mechanics/CLI/rules/conditions.md#poisoned)\
...
- "SatO"
- "ToFW"
"image": "/3-Mechanics/CLI/bestiary/fiend/token/pit-fiend.png"
```
^statblock
