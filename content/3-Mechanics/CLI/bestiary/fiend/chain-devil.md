...
SourceType: Bestiary
BookSource: Monster Manual p. 72. Available in the SRD.
---
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 10 ft., one target. Hit: 11 (2d6\
    \ + 4) slashing damage. The target is [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled)\
...
- "PaBTSO"
- "BMT"
"image": "/3-Mechanics/CLI/bestiary/fiend/token/chain-devil.png"
```
^statblock
