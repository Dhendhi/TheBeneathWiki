...
- "desc": "The oinoloth touches one willing creature within 5 feet of it. The target\
    ...
    \ restoration](/3-Mechanics/CLI/spells/greater-restoration.md) on the target three\
...
- "desc": "The oinoloth blights the area in a 30-foot-radius sphere centered on itself.\
    ...
    \ 24 hours.\n\nThe [poisoned](/3-Mechanics/CLI/rules/conditions.md#poisoned) creature\
    \ can't regain hit points. After every 24 hours that elapse, the [poisoned](/3-Mechanics/CLI/rules/conditions.md#poisoned)\
...
- "MPMM"
- "MTF"
"image": "/3-Mechanics/CLI/bestiary/fiend/token/oinoloth.png"
```
^statblock
