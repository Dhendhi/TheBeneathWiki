...
- "desc": "The kobold uses one of the following options (choose one or roll a d8);\
    ...
    \ 20 feet of it. A [swarm of insects (centipedes)](/3-Mechanics/CLI/bestiary/beast/swarm-of-centipedes.md)\
    ...
    \ A [swarm of rot grubs](/3-Mechanics/CLI/bestiary/beast/swarm-of-rot-grubs-mpmm.md)\
    ...
    \ saving throw, or it retches and is [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated)\
...
- "MPMM"
- "VGM"
"image": "/3-Mechanics/CLI/bestiary/humanoid/token/kobold-inventor.png"
```
^statblock
