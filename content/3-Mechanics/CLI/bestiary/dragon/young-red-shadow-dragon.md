...
The dragon's proficiency bonus is doubled for its Dexterity ([Stealth](content/3-Mechanics/CLI/rules/skills.md#Stealth)) checks.
...
While in sunlight, the dragon has disadvantage on attack rolls, as well as on Wisdom ([Perception](content/3-Mechanics/CLI/rules/skills.md#Perception)) checks that rely on sight.
...
- "MM"
- "AATM"
"image": "/3-Mechanics/CLI/bestiary/dragon/token/young-red-shadow-dragon.png"
```
^statblock
