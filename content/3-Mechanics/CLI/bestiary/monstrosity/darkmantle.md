...
SourceType: Bestiary
BookSource: Monster Manual p. 46. Available in the SRD.
---
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 6 (1d6\
    ...
    \ it attaches by engulfing the target's head, and the target is also [blinded](/3-Mechanics/CLI/rules/conditions.md#blinded)\
...
- "WBtW"
- "KftGV"
"image": "/3-Mechanics/CLI/bestiary/monstrosity/token/darkmantle.png"
```
^statblock
