...
- "desc": "Melee Weapon Attack: +10 to hit, reach 15 ft., one Large or smaller creature.\
    ...
    \ DC 16). Until this grapple ends, the target is [restrained](/3-Mechanics/CLI/rules/conditions.md#restrained),\
...
- "MPMM"
- "VGM"
"image": "/3-Mechanics/CLI/bestiary/monstrosity/token/yuan-ti-anathema.png"
```
^statblock
