...
- "desc": "Melee Weapon Attack: +7 to hit, reach 30 ft., one target. Hit: 20 (4d8\
    ...
    \ grapple ends. The elder brain can have up to four targets [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled)\
    \ at a time."
  "name": "Tentacle"
...
- "VGM"
- "PaBTSO"
"image": "/3-Mechanics/CLI/bestiary/aberration/token/elder-brain.png"
```
^statblock
