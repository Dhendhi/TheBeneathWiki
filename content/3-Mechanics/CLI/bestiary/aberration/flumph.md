...
SourceType: Bestiary
BookSource: Monster Manual p. 135
---
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 4 (1d4\
    ...
    \ [lesser restoration](/3-Mechanics/CLI/spells/lesser-restoration.md) spell cast\
...
- "PaBTSO"
- "BMT"
"image": "/3-Mechanics/CLI/bestiary/aberration/token/flumph.png"
```
^statblock
