...
- "desc": "Melee Weapon Attack: +13 to hit, reach 15 ft., one target. Hit: 21\
    ...
    \ or be swallowed by the neothelid. A swallowed creature is [blinded](/3-Mechanics/CLI/rules/conditions.md#blinded)\
...
- "MPMM"
- "VGM"
"image": "/3-Mechanics/CLI/bestiary/aberration/token/neothelid.png"
```
^statblock
