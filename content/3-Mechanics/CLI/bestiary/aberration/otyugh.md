...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 12 (2d8\
    ...
    \ 15 Constitution saving throw against disease or become [poisoned](/3-Mechanics/CLI/rules/conditions.md#poisoned)\
...
- "ToFW"
- "DoDk"
"image": "/3-Mechanics/CLI/bestiary/aberration/token/otyugh.png"
```
^statblock
