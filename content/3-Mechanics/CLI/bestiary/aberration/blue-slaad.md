...
SourceType: Bestiary
BookSource: Monster Manual p. 276
---
...
> 
> Someone who is proficient in Wisdom ([Medicine](content/3-Mechanics/CLI/rules/skills.md#Medicine)) can remove the gem from an [incapacitated](conditions.md#incapacitated) slaad. Each try requires 1 minute of uninterrupted work and a successful DC 20 Wisdom ([Medicine](content/3-Mechanics/CLI/rules/skills.md#Medicine)) check. Each failed attempt deals 22 (`4d10`) psychic damage to the slaad.
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one target. Hit: 12 (2d6\
    ...
    \ hit point maximum to 0, the target instantly transforms into a [red slaad](/3-Mechanics/CLI/bestiary/aberration/red-slaad.md)\
    \ or, if it has the ability to cast spells of 3rd level or higher, a [green slaad](/3-Mechanics/CLI/bestiary/aberration/green-slaad.md).\
...
- "PaBTSO"
- "SatO"
"image": "/3-Mechanics/CLI/bestiary/aberration/token/blue-slaad.png"
```
^statblock
