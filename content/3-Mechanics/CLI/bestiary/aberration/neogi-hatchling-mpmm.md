...
- "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one target. Hit: 3 (1d4\
    ...
    \ on a DC 10 Constitution saving throw or become [poisoned](/3-Mechanics/CLI/rules/conditions.md#poisoned)\
...
- "VGM"
- "SjA"
"image": "/3-Mechanics/CLI/bestiary/aberration/token/neogi-hatchling.png"
```
^statblock
