...
BestiaryType: beast
SourceType: Bestiary
BookSource: Monster Manual p. 329, Tasha's Cauldron of Everything. Available in the SRD and the Basic Rules.
---
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 7 (1d10\
    \ + 2) piercing damage plus 5 (1d10) poison damage, and the target is [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled)\
...
- "desc": "The toad makes one bite attack against a Medium or smaller target it is\
    ...
    \ no longer [restrained](/3-Mechanics/CLI/rules/conditions.md#restrained) by it\
...
- "WBtW"
- "KftGV"
"image": "/3-Mechanics/CLI/bestiary/beast/token/giant-toad.png"
```
^statblock
