...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 4 (1d4\
    ...
    \ to 0 hit points, the target is stable but [poisoned](/3-Mechanics/CLI/rules/conditions.md#poisoned)\
...
- "PSX"
- "PSA"
"image": "/3-Mechanics/CLI/bestiary/beast/token/giant-centipede.png"
```
^statblock
