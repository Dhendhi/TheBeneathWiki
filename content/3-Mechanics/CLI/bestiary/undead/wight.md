...
BestiaryType: undead
SourceType: Bestiary
BookSource: Monster Manual p. 300. Available in the SRD and the Basic Rules.
---
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 5 (1d6\
    ...
    \ attack rises 24 hours later as a [zombie](/3-Mechanics/CLI/bestiary/undead/zombie.md)\
...
- "BMT"
- "DoDk"
"image": "/3-Mechanics/CLI/bestiary/undead/token/wight.png"
```
^statblock
