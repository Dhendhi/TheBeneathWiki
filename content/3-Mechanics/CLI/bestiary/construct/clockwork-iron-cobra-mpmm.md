...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 6 (1d6\
    ...
    \ is visible within 30 feet, it takes the [Dash](/3-Mechanics/CLI/rules/actions.md#Dash)\
    \ action, moving toward the nearest creature.  \n- 3–4 Paralysis. The target\
    \ is [paralyzed](/3-Mechanics/CLI/rules/conditions.md#paralyzed) until the end\
...
- "MPMM"
- "MTF"
"image": "/3-Mechanics/CLI/bestiary/construct/token/clockwork-iron-cobra.png"
```
^statblock
