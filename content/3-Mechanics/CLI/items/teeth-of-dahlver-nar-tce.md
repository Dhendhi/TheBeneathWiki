...
| 8 | Beyond the Rock of Bral (silver mind flayer tooth) | 2 [mind flayers](/3-Mechanics/CLI/bestiary/aberration/mind-flayer.md) | You gain telepathy out to 120 feet as described in the Monster Manual, and you can cast the [detect thoughts](/3-Mechanics/CLI/spells/detect-thoughts.md) spell at will, requiring no components. You also have disadvantage on Wisdom ([Insight](/3-Mechanics/CLI/rules/skills.md#Insight)) and Wisdom ([Perception](/3-Mechanics/CLI/rules/skills.md#Perception)) checks from constant whispers of memories and nearby minds. |
