...
| 2 | Multiple [category 3 krasis](/3-Mechanics/CLI/bestiary/monstrosity/category-3-krasis-ggr.md) under no one's control emerge from canals throughout the city. |
...
| 5 | A sage of the Gyre Clade accidentally creates an [antimagic field](/3-Mechanics/CLI/spells/antimagic-field.md) that slowly spreads over the neighborhood. |
