...
| 16-20 | The artifact houses a bodiless life force that is hostile toward you. Each time you use an action to use one of the artifact's properties, there is a 50% chance chance that the life force tries to leave the artifact and enter your body. If you fail a DC 20 Charisma saving throw, it succeeds, and you become an NPC under the DM's control until the intruding life force is banished using magic such as the [dispel evil and good](/3-Mechanics/CLI/spells/dispel-evil-and-good.md) spell. |
...
| 26-30 | The artifact imprisons a [death slaad](/3-Mechanics/CLI/bestiary/aberration/death-slaad.md) (see the Monster Manual). Each time you use one of the artifact's properties as an action, the slaad has a 10% chance chance of escaping, whereupon it appears within 15 feet of you and attacks you. |
...
| 96-00 | When you become attuned to the artifact, there is a 10% chance chance that you attract the attention of a god that sends an avatar to wrest the artifact from you. The avatar has the same alignment as its creator and the statistics of an [empyrean](/3-Mechanics/CLI/bestiary/celestial/empyrean.md) (see the Monster Manual). Once it obtains the artifact, the avatar vanishes. |
^major-detrimental-properties