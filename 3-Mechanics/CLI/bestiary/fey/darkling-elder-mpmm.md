...
- "desc": "When the darkling elder dies, magical light flashes out from it in a 10-foot\
    ...
    \ On a failed save, the creature takes 7 (2d6) radiant damage and is [blinded](/3-Mechanics/CLI/rules/conditions.md#blinded)\
...
- "MPMM"
- "VGM"
"image": "/3-Mechanics/CLI/bestiary/fey/token/darkling-elder.png"
```
^statblock
