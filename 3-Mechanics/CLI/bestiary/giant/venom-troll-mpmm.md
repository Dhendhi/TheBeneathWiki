...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one target. Hit: 7 (1d6\
    \ + 4) piercing damage plus 4 (1d8) poison damage, and the creature is [poisoned](/3-Mechanics/CLI/rules/conditions.md#poisoned)\
...
- "desc": "The troll slices itself with a claw, releasing a spray of poison in a 15-foot\
    ...
    \ throw. On a failed save, a creature takes 18 (4d8) poison damage and is [poisoned](/3-Mechanics/CLI/rules/conditions.md#poisoned)\
...
- "MPMM"
- "MTF"
"image": "/3-Mechanics/CLI/bestiary/giant/token/venom-troll.png"
```
^statblock
