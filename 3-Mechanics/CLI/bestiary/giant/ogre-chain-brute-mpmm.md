...
- "desc": "The ogre swings its chain, and every creature within 10 feet of it must\
    ...
    \ 8 (1d8 + 4) bludgeoning damage and is knocked [prone](/3-Mechanics/CLI/rules/conditions.md#prone).\
...
- "MPMM"
- "MTF"
"image": "/3-Mechanics/CLI/bestiary/giant/token/ogre-chain-brute.png"
```
^statblock
