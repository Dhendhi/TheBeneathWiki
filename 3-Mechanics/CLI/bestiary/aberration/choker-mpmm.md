...
- "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one target. Hit: 5 (1d4\
    \ + 3) piercing damage. If the target is a Large or smaller creature, it is [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled)\
...
- "MPMM"
- "MTF"
"image": "/3-Mechanics/CLI/bestiary/aberration/token/choker.png"
```
^statblock
