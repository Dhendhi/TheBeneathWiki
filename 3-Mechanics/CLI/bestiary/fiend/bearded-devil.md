...
SourceType: Bestiary
BookSource: Monster Manual p. 70. Available in the SRD.
---
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 6 (1d8\
    ...
    \ minute. While [poisoned](/3-Mechanics/CLI/rules/conditions.md#poisoned) in this\
...
- "BMT"
- "DoDk"
"image": "/3-Mechanics/CLI/bestiary/fiend/token/bearded-devil.png"
```
^statblock
