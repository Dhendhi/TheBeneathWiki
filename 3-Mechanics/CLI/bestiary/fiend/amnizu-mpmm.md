...
- "desc": "The amnizu targets one or two creatures that it can see within 60 feet\
    ...
    \ necrotic damage and be [blinded](/3-Mechanics/CLI/rules/conditions.md#blinded)\
...
- "desc": "The amnizu targets one creature it can see within 60 feet of it. That creature\
    ...
    \ damage and become [stunned](/3-Mechanics/CLI/rules/conditions.md#stunned) for\
    \ 1 minute. A [stunned](/3-Mechanics/CLI/rules/conditions.md#stunned) creature\
...
- "MPMM"
- "MTF"
"image": "/3-Mechanics/CLI/bestiary/fiend/token/amnizu.png"
```
^statblock
