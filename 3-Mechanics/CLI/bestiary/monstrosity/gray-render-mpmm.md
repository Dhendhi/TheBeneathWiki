...
- "desc": "Melee Weapon Attack: +8 to hit, reach 10 ft., one target. Hit: 13 (2d8\
    \ + 4) slashing damage, plus 10 (3d6) bludgeoning damage if the target is [prone](/3-Mechanics/CLI/rules/conditions.md#prone)."
  "name": "Claw"
"reactions":
...
- "MPMM"
- "MTF"
"image": "/3-Mechanics/CLI/bestiary/monstrosity/token/gray-render.png"
```
^statblock
