...
SourceType: Bestiary
BookSource: Monster Manual p. 21. Available in the SRD.
---
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 10 (2d6\
    ...
    \ smaller creature, it is [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled)\
...
- "KftGV"
- "BMT"
"image": "/3-Mechanics/CLI/bestiary/monstrosity/token/ankheg.png"
```
^statblock
