...
- "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit: 22 (3d10\
    ...
    \ creature. A swallowed creature is [blinded](/3-Mechanics/CLI/rules/conditions.md#blinded)\
    ...
    \ all swallowed creatures, each of which falls [prone](/3-Mechanics/CLI/rules/conditions.md#prone)\
...
- "desc": "Melee Weapon Attack: +10 to hit, reach 20 ft., one target. Hit: 19\
    \ (3d8 + 6) bludgeoning damage, and the target is [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled)\
...
- "MPMM"
- "VGM"
"image": "/3-Mechanics/CLI/bestiary/monstrosity/token/froghemoth.png"
```
^statblock
