...
SourceType: Bestiary
BookSource: Monster Manual p. 143, Tasha's Cauldron of Everything
---
...
- "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit: 20 (4d6\
    ...
    \ succeed on a DC 18 Strength check or be knocked [prone](/3-Mechanics/CLI/rules/conditions.md#prone)."
  "name": "Maul"
"source":
- "MM"
- "PotA"
...
- "CM"
- "SatO"
"image": "/3-Mechanics/CLI/bestiary/elemental/token/dao.png"
```
^statblock
