...
SourceType: Bestiary
BookSource: Monster Manual p. 43. Available in the SRD.
---
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 10 ft., one Medium or smaller creature.\
    \ Hit: 10 (2d6 + 3) bludgeoning damage, and the target is [grappled](/3-Mechanics/CLI/rules/conditions.md#grappled)\
...
- "PSX"
- "BMT"
"image": "/3-Mechanics/CLI/bestiary/celestial/token/couatl.png"
```
^statblock
