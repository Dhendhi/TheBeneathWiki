...
BestiaryType: ooze
SourceType: Bestiary
BookSource: Monster Manual p. 242. Available in the SRD.
---
...
- "desc": "The cube moves up to its speed. While doing so, it can enter Large or smaller\
    ...
    \ is [restrained](/3-Mechanics/CLI/rules/conditions.md#restrained), and takes\
...
- "BMT"
- "DoDk"
"image": "/3-Mechanics/CLI/bestiary/ooze/token/gelatinous-cube.png"
```
^statblock
