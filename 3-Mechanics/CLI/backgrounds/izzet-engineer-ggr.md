...
NoteIcon: background
BookSource: Guildmasters' Guide to Ravnica p. 66
---
# Izzet Engineer
*Source: Guildmasters' Guide to Ravnica p. 66*  

- **Skill Proficiencies.** [Arcana](/3-Mechanics/CLI/rules/skills.md#Arcana), [Investigation](/3-Mechanics/CLI/rules/skills.md#Investigation)  
- **Tool Proficiencies.** One type of artisan's tools  
- **Languages.** Choose one of Draconic, Goblin, or Vedalken  
- **Equipment.** An Izzet insignia, one set of artisan's tools, the charred and twisted remains of a failed experiment, a [hammer](/3-Mechanics/CLI/items/hammer.md), a [block and tackle](/3-Mechanics/CLI/items/block-and-tackle.md), a set of [common clothes](/3-Mechanics/CLI/items/common-clothes.md), and a belt [pouch](/3-Mechanics/CLI/items/pouch.md) containing 5 gp (Azorius 1-zino coins)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [produce flame](/3-Mechanics/CLI/spells/produce-flame.md), [shocking grasp](/3-Mechanics/CLI/spells/shocking-grasp.md) |
| 1st | [chaos bolt](/3-Mechanics/CLI/spells/chaos-bolt-xge.md), [create or destroy water](/3-Mechanics/CLI/spells/create-or-destroy-water.md), [unseen servant](/3-Mechanics/CLI/spells/unseen-servant.md) |
| 2nd | [heat metal](/3-Mechanics/CLI/spells/heat-metal.md), [rope trick](/3-Mechanics/CLI/spells/rope-trick.md) |
| 3rd | [call lightning](/3-Mechanics/CLI/spells/call-lightning.md), [elemental weapon](/3-Mechanics/CLI/spells/elemental-weapon.md), [glyph of warding](/3-Mechanics/CLI/spells/glyph-of-warding.md) |
| 4th | [conjure minor elementals](/3-Mechanics/CLI/spells/conjure-minor-elementals.md), [divination](/3-Mechanics/CLI/spells/divination.md), [Otiluke's resilient sphere](/3-Mechanics/CLI/spells/otilukes-resilient-sphere.md) |
| 5th | [animate objects](/3-Mechanics/CLI/spells/animate-objects.md), [conjure elemental](/3-Mechanics/CLI/spells/conjure-elemental.md) |
^izzet-guild-spells

Your spells tend to be loud, flashy, or explosive, even when the effect is unremarkable. For example, when you open the portal of a [rope trick](/3-Mechanics/CLI/spells/rope-trick.md) spell, the portal might be outlined by harmless, showy sparkles.
