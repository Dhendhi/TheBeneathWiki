...
![Plasmoid Astral Drifter](/3-Mechanics/CLI/backgrounds/img/astral-drifter.webp#right)  
...
- **Equipment.** A set of [traveler's clothes](/3-Mechanics/CLI/items/travelers-clothes.md), a diary, an [ink pen](/3-Mechanics/CLI/items/ink-pen.md), a [bottle of ink](/3-Mechanics/CLI/items/ink-1-ounce-bottle.md), and a [pouch](/3-Mechanics/CLI/items/pouch.md) containing 10 gp  
...
You gain the [Magic Initiate feat](/3-Mechanics/CLI/feats/magic-initiate.md) from the "Player's Handbook" and must choose cleric for the feat.
