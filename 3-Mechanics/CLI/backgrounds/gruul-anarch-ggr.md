...
NoteIcon: background
BookSource: Guildmasters' Guide to Ravnica p. 60
---
# Gruul Anarch
*Source: Guildmasters' Guide to Ravnica p. 60*  

- **Skill Proficiencies.** [Animal Handling](/3-Mechanics/CLI/rules/skills.md#Animal%20Handling), [Athletics](/3-Mechanics/CLI/rules/skills.md#Athletics)  
...
- **Equipment.** A Gruul insignia, a [hunting trap](/3-Mechanics/CLI/items/hunting-trap.md), an [herbalism kit](/3-Mechanics/CLI/items/herbalism-kit.md), the skull of a boar, a beast-hide cloak, a set of [traveler's clothes](/3-Mechanics/CLI/items/travelers-clothes.md), and a belt [pouch](/3-Mechanics/CLI/items/pouch.md) containing 10 gp (Azorius 1-zino coins)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [fire bolt](/3-Mechanics/CLI/spells/fire-bolt.md), [produce flame](/3-Mechanics/CLI/spells/produce-flame.md) |
| 1st | [compelled duel](/3-Mechanics/CLI/spells/compelled-duel.md), [speak with animals](/3-Mechanics/CLI/spells/speak-with-animals.md), [thunderwave](/3-Mechanics/CLI/spells/thunderwave.md) |
| 2nd | [beast sense](/3-Mechanics/CLI/spells/beast-sense.md), [shatter](/3-Mechanics/CLI/spells/shatter.md) |
| 3rd | [conjure animals](/3-Mechanics/CLI/spells/conjure-animals.md), [conjure barrage](/3-Mechanics/CLI/spells/conjure-barrage.md) |
| 4th | [dominate beast](/3-Mechanics/CLI/spells/dominate-beast.md), [stoneskin](/3-Mechanics/CLI/spells/stoneskin.md) |
| 5th | [destructive wave](/3-Mechanics/CLI/spells/destructive-wave.md) |
^gruul-guild-spells
